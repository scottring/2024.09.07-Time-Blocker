            ...
            VStack(spacing: 0) {
                VStack(spacing: 0) {
                    ...
                    HStack {
                        ...
                        // Center
                        ColorPickerView(selectedColor: $selectedColor, penSize: $penSize, canvasView: $canvasView, isErasing: $isErasing)
                    ...
                    VStack(spacing: 0) {
                        ...
                        ScrollView(.vertical, showsIndicators: false) {
                            ZStack {
                                ...
                                DrawingView(canvasView: $canvasView, selectedColor: $selectedColor, penSize: $penSize, isErasing: $isErasing)
...
struct HeaderView: View {
    ...
    var body: some View {
        HStack {
            ...
            Spacer()
            ColorPickerView(selectedColor: $selectedColor, penSize: $penSize, canvasView: $canvasView)
            Spacer()
            Button(action: {
                canvasView.drawing = PKDrawing()
            }) {
