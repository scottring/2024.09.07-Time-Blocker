...
struct ContentView: View {
    ...
    private func printCurrentSheet() {
        let printView = PrintView(drawing: canvasView.drawing)
        let hostingController = UIHostingController(rootView: printView)
        hostingController.view.frame = CGRect(x: 0, y: 0, width: 792, height: 612) // 11x8.5 inches at 72 DPI
        
        // Add the view to the app's window hierarchy temporarily
        ...
        // Debug: Save the image to check if it's rendered correctly
